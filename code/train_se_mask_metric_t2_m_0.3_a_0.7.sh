...
GPU="${GPU:-7}"
RUN_NAME="${RUN_NAME:-se_mask_triplet_arcface_t2_m_0.3_a_0.7}"
...
INITIAL_MODEL="${INITIAL_MODEL:-/mnt/hard2/litcoderr/project/ee40034/code/exps/se_t1/epoch0004.model}"
