...
GPU="${GPU:-3}"
RUN_NAME="${RUN_NAME:-se_mask_triplet_arcface_t2_1_1}"
...
INITIAL_MODEL="${INITIAL_MODEL:-/mnt/hard2/litcoderr/project/ee40034/code/exps/se_mask_triplet_arcface_t1_1_1/epoch0008.model}"
