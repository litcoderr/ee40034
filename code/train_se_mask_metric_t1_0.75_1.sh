...
GPU="${GPU:-4}"
RUN_NAME="${RUN_NAME:-se_mask_triplet_arcface_t1_0.75_1}"
...
INITIAL_MODEL="${INITIAL_MODEL:-/mnt/hard2/litcoderr/project/ee40034/code/exps/se_mask_triplet_arcface_t2/epoch0036.model}"
